...
namespace TempManager.BL.Services.Implementations.Test
{
	...
	public class RoomTestService : IRoomService
	{
		...
		{
			new Room(1, "A1042 MTI Diblik", "A1042 MTI Diblik", true, false, 21.26, 41, 21, false),
			new Room(2, "A1043 MTI Tyl", "A1043 MTI Tyl", true, false, 22.98, 25, 23, true),
			new Room(3, "A1044 MTI Rous", "A1044 MTI Rous", true, false, 23.48, 28, 24, true),
			new Room(4, "A1045 MTI rekr", "A1045 MTI rekr", true, false, 23.280001, 33, 23.5, true)
		};
